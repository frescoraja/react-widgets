...
/***/ function(module, exports, __webpack_require__) {
	...
	var _clock = __webpack_require__(169);
	...
	var panes = [{ title: "Severed heads!", content: "This scares me so much!" }, { title: "Moshi-moshi!", content: "Pandas vomit rainbows" }, { title: "Random stuff", content: "Keep adding some random shit!" }, { title: "Mas y mas", content: "poco a poco estamos mirando a la mierda!" }];
	
	var items = [{ name: "Backbonejs", url: "http://backbonejs.org" }, { name: "Angularjs", url: "http://www.angularjs.org" }, { name: "Reactjs", url: "http://www.reactjs.org" }, { name: "Emberjs", url: "http://www.emberjs.org" }, { name: "Elm", url: "http://www.elm.com" }, { name: "Meteorjs", url: "http://www.meteorjs.org" }, { name: "Ruby", url: "http://www.ruby-doc.org" }, { name: "Nodejs", url: "http://www.nodejs.org" }, { name: "Python", url: "http://www.python.org" }];
	
	var names = ["David", "Jeff", "Marshall", "Joe", "Yuki", "Ned", "Nishant", "Kush", "Tokuyuki"];
	...
	var Widgets = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(_clock.Weather, null),
	      _react2.default.createElement(_tabs2.default, { panes: panes }),
	      _react2.default.createElement(_autocomplete2.default, { items: names })
	    );
	  }
	});
	
	document.addEventListener("DOMContentLoaded", function () {
	  _reactDom2.default.render(_react2.default.createElement(Widgets, null), document.getElementById("main"));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Weather = exports.Clock = undefined;
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        null,
	        "Time: ",
	        this.state.currentTime.toTimeString()
	      ),
	      _react2.default.createElement(
	        "p",
	        null,
	...
	var Weather = _react2.default.createClass({
	  ...
	  pollWeather: function pollWeather(location) {
	    ...
	    var apiKey = "818e1e033a7c8c2381c0c306a115e09c";
	    url += "&APPID=" + apiKey;
	    ...
	    xmlhttp.onreadystatechange = function () {
	      if (xmlhttp.status === 200 && xmlhttp.readyState === 4) {
	        _this.setState({ weather: xmlhttp.response });
	      }
	    };
	...
	var AutoComplete = _react2.default.createClass({
	  ...
	  matches: function matches() {
	    ...
	    this.props.items.forEach(function (name) {
	      var sub = name.slice(0, _this.state.query.length);
	      if (sub.toLowerCase() === _this.state.query.toLowerCase()) {
	        matches.push(name);
	      }
	    });
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      'div',
	      null,
	      _react2.default.createElement('input', { onChange: this.handleChange, value: this.state.query }),
	      _react2.default.createElement(
	        'ul',
	        null,
	        _react2.default.createElement(
